...
motor_speed_slider_case = tk.Scale(root, from_=1, to=1000, orient="horizontal")
...
motor_speed_slider_disc = tk.Scale(root, from_=1, to=1000, orient="horizontal")
motor_speed_slider_disc.set(750)
